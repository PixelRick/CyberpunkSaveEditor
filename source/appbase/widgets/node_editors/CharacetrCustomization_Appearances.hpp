...
#include <redx/csav/nodes/CharacetrCustomization_Appearances.h>
#include <redx/utils.hpp>

struct cetr_uk_thing5_widget {
    // returns true if content has been edited
    [[nodiscard]] static inline bool draw(redx::csav::cetr_uk_thing5& x) {
...
struct cetr_uk_thing4_widget {
    // returns true if content has been edited
    [[nodiscard]] static inline bool draw(redx::csav::cetr_uk_thing4& x) {
        ImGuiWindow* window = ImGui::GetCurrentWindow();
        if (window->SkipItems)
            return false;
...
struct cetr_uk_thing3_widget {
    // returns true if content has been edited
    [[nodiscard]] static inline bool draw(redx::csav::cetr_uk_thing3& x) {
        ImGuiWindow* window = ImGui::GetCurrentWindow();
        if (window->SkipItems)
            return false;
...
struct cetr_uk_thing2_widget {
    // returns true if content has been edited
    [[nodiscard]] static inline bool draw(redx::csav::cetr_uk_thing2& x) {
        ImGuiWindow* window = ImGui::GetCurrentWindow();
        if (window->SkipItems)
            return false;
        ...
        if (ImGui::TreeNode("Array #1##cetr2")) {
            static auto name_fn = [](const redx::csav::cetr_uk_thing3& y) {
                return y.cn.gstr().string();
            };
            modified |= imgui_list_tree_widget(
                x.vuk3, name_fn, &cetr_uk_thing3_widget::draw, 0, true, true);
            ImGui::TreePop();
        }
        if (ImGui::TreeNode("Array #2##cetr2")) {
            static auto name_fn = [](const redx::csav::cetr_uk_thing4& y) { return y.uk0; };
            modified |= imgui_list_tree_widget(
                x.vuk4, name_fn, &cetr_uk_thing4_widget::draw, 0, true, true);
            ImGui::TreePop();
        }
...
struct cetr_uk_thing1_widget {
    ...
    draw(redx::csav::cetr_uk_thing1& x, bool editable_list = false) {
        ImGuiWindow* window = ImGui::GetCurrentWindow();
        if (window->SkipItems)
            return false;
        ...
        static auto name_fn = [](const redx::csav::cetr_uk_thing2& y) { return y.uks; };
        modified |= imgui_list_tree_widget(
            x.vuk2, name_fn, &cetr_uk_thing2_widget::draw, 0, editable_list, editable_list);
...
struct CCharacterCustomization_widget {
    // returns true if content has been edited
    [[nodiscard]] static inline bool draw(redx::csav::CCharacterCustomization& x) {
        ImGuiWindow* window = ImGui::GetCurrentWindow();
        if (window->SkipItems)
            return false;
        ...
        if (ImGui::TreeNode("Array #1##cetr")) {
            static auto name_fn = [](const redx::csav::cetr_uk_thing5& y) {
                return std::string("unnamed");
            };
            modified |= imgui_list_tree_widget(
                x.ukt5, name_fn, &cetr_uk_thing5_widget::draw, 0, true, true);
            ImGui::TreePop();
        }

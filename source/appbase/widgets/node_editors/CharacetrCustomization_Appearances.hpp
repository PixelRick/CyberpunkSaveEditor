...
#include "redx/csav/nodes/CCharacterCustomization.hpp"
#include "hexedit.hpp"
...
struct cetr_uk_thing2_widget
{
  ...
  [[nodiscard]] static inline bool draw(redx::csav::cetr_uk_thing2& x)
  {
    ...
    {
      static auto name_fn = [](const redx::csav::cetr_uk_thing3& y) { return y.cn.gstr().string(); };
...
{
  // returns true if content has been edited
  [[nodiscard]] static inline bool draw(redx::csav::cetr_uk_thing1& x, bool editable_list = false)
  {
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    if (window->SkipItems)
      return false;
...
struct CCharacterCustomization_widget
{
  ...
  [[nodiscard]] static inline bool draw(redx::csav::CCharacterCustomization& x)
  {
    ...
    {
      static auto name_fn = [](const redx::csav::cetr_uk_thing5& y) { return std::string("unnamed"); };

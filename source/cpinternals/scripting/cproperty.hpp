...
public:
  ...
  gname ctypename() const override { return m_typename; };
...
public:
  ...
  gname ctypename() const override { return m_obj_ctypename; };
...
public:
  ...
  gname ctypename() const override { return m_enum_name; };
